...
public class ShiroConfig {
    ...
    public DefaultWebSecurityManager securityManager(){
        ...
        realm.setAuthenticationCacheName("loginResultCache");
        securityManager.setRealm(realm);
        securityManager.setCacheManager(getEhCahceManager());
        //rememberme
    ...
    @Bean
    public CacheManager getEhCahceManager() {
        EhCacheManager ehCacheManager = new EhCacheManager();
        InputStream in = null;
        try {
            in = ResourceUtils.getInputStreamForPath("classpath:ehcache-shiro.xml");
            net.sf.ehcache.CacheManager manager = new net.sf.ehcache.CacheManager(in);
